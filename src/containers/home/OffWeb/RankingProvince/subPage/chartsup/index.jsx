...
class Charts extends React.Component {
    ...
    componentDidMount() {
        ...
        this.getOption(this.props.dataasc,this.props.options);
        window.addEventListener('resize', this.myChart.resize);
    }

    componentWillReceiveProps(nextProps){
        if(JSON.stringify(nextProps.dataasc) === JSON.stringify(this.props.dataasc)){
            return false;
        }
        this.getOption(nextProps.dataasc,nextProps.options);
        this.myChart.resize()
    }
