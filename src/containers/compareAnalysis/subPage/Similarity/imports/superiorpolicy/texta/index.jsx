...
import style from './PopupA/style.scss';
import Super from './PopupA';
...
export default class TextB extends Component {
    constructor(props) {
        ...
        this.state = {
            visible:false,
            visibleNo:false,
            ku:this.props.handleIdA.text,
            data:[],
            datat:'',
            details:{},
            title:'',
            texts:{
                text: this.props.handleIdA.text ? this.props.handleIdA.text : this.props.handImportA
            }
        };
    }
    ...
    componentWillReceiveProps(nextProps){
        this.setState({
            texts:{
                text: nextProps.text ? nextProps.text : nextProps.handImportA
            },
            noData:nextProps.noData,
            ku:nextProps.handleIdA.text
        })
        this.getData(this.state.texts.text = nextProps.text ? nextProps.text : nextProps.handImportA)
    }
    ...
    render() {
        const { showAlert, data, visibleNo, ku} = this.state;
